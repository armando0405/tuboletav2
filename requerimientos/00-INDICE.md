...
|----|--------|--------|--------|----------------------|
| REQ-ARQ-001 | Arquitectura del backend en capas | arquitectura | implementado | 2026-07-06 |
| REQ-ARQ-002 | Convenciones de utils y envelope de respuestas | arquitectura | implementado | 2026-07-06 |
| REQ-ARQ-003 | DTOs de entrada como records | arquitectura | implementado | 2026-07-06 |
| REQ-ARQ-004 | Separación de responsabilidades por dominio | arquitectura | implementado | 2026-07-06 |
...
| REQ-BUS-001 | Búsqueda multi-proveedor (N:M) | busquedas | implementado | 2026-07-06 |
...
| REQ-BUS-004 | Ciclo de vida de una búsqueda | busquedas | implementado | 2026-07-06 |
| REQ-BUS-005 | Frecuencia de monitoreo elegida por el usuario | busquedas | implementado | 2026-07-06 |
...
| REQ-DET-004 | Scheduler de monitoreo | deteccion | implementado | 2026-07-06 |
| REQ-DET-005 | Mecanismo de ejecución del scheduler — la BD es la cola | deteccion | implementado | 2026-07-06 |
...
| REQ-FUE-002 | Estado visible cuando una fuente se deshabilita | fuentes | implementado | 2026-07-06 |
| REQ-NOT-001 | Destinos de notificación por usuario (1:N, reutilizables) | notificaciones | implementado | 2026-07-06 |
| REQ-NOT-002 | Email como único canal activo | notificaciones | implementado | 2026-07-05 |
| REQ-NOT-003 | Centro de notificaciones in-app (inbox) | notificaciones | implementado | 2026-07-06 |
...
| REQ-USU-001 | Roles ADMIN y USER | usuarios | implementado | 2026-07-06 |
| REQ-USU-002 | Autenticación básica | usuarios | implementado | 2026-07-06 |
