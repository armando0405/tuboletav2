...
const POST_PROVIDER = CONTROLLER_ADMIN_PROVIDERS
const PATCH_PROVIDER = (id: number): string => `${CONTROLLER_ADMIN_PROVIDERS}/${id}`
...
export {
    ...
    POST_PROVIDER,
    PATCH_PROVIDER,
    POST_DISABLE_PROVIDER,
    POST_ENABLE_PROVIDER,
}
